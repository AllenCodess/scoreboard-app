...
function disabledButtons() {
  awayTouchdownEl.disabled = true;
  awayExtraEl.disabled = true;
  awayFgEl.disabled = true;
  homeTouchdownEl.disabled = true;
  homeExtraEl.disabled = true;
  homeFgEl.disabled = true;
}

function enabledButtons() {
  awayTouchdownEl.disabled = false;
  awayExtraEl.disabled = false;
  awayFgEl.disabled = false;
  homeTouchdownEl.disabled = false;
  homeExtraEl.disabled = false;
  homeFgEl.disabled = false;
}
